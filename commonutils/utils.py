...
people_on_linkedin='people on linkedin'
...
def any_one_element_css(driver, element, list_by, default=None):
    for one_by in list_by:
        try:
            return driver.find_element_by_css_selector(one_by)
        except Exception as e:
            print("not found")
    return default


def any_one_element_xpath(driver, element, list_by, default=None):
    for one_by in list_by:
        try:
            return driver.find_element_by_xpath(one_by)
        except Exception as e:
            print("not found")
    return default


def any_one(element, selector, default=None):
    try:
